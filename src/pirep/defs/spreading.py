...
NEG_RISKS_ALT = [[-4, -3.3, -2.5,   -2, -1.5, 0,    1,    1.5,  2.25, 3.5,  6,    np.inf], 
                 [ 1, 0.97, 0.95, 0.93, 0.91, 0.89, 0.91, 0.93, 0.95, 0.97, 0.99, 1]]
LGT_RISKS_ALT = [[-4, -3,   -1.6, 0.6, 2 , 3.6, 6,   np.inf], 
                 [0,   0.075,  .15,  .75,  .15, 0.075, 0.035, 0]]
MOD_RISKS_ALT = [[-4, -3, 1.5, 2.75, 4  , 6  , np.inf], 
                 [ 0, .15, .35,  .15,   0.075, 0.035, 0]]
SEV_RISKS_ALT = [[-4, -3.5, -1, -0.5, 1.25, 2.5, 3.5, 4.5, 6, np.inf], 
